# udacity--Project-4-Map-My-World
This project “Map-My-World” is to create a 2D occupancy grid and 3D octomap from a simulated environment using your own robot with the RTAB-Map package as a part of the course-project in Robotics Software Engineer Nanodegree Program.
